...
class Sms extends GlobeApi
{
    ...
    $accesstoken = null, $number = null, $message = null, $bodyOnly = true
    )
    {
        if ($accesstoken) {
        ...
        $url = sprintf(
                Sms::CURL_URL, GlobeAPI::API_ENDPOINT, $this->version, urlencode($this->address)
        );
